...
public class BuildingApplication {
    ...
    public static void main(String[] args) {
        ...
        // context.getBean(SpaceTypeRepository.class);
    ...
    // SpaceType buildingType = spaceTypes.stream().filter((type) ->
    // type.getName().equals("BLOCK")).toList()
    // .getFirst();
    ...
    // SpaceType floorType = spaceTypes.stream().filter((type) ->
    // type.getName().equals("FLOOR")).toList()
    // .getFirst();
    ...
    // SpaceType roomType = spaceTypes.stream().filter((type) ->
    // type.getName().equals("LIBRARY")).toList()
    // .getFirst();
    ...
    // private static void seedUser(UserRepository userRepository, PasswordEncoder
    // passwordEncoder) {
